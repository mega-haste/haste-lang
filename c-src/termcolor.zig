...
pub export fn supports_color(arg_stream: [*c]FILE) bool {
    var stream = arg_stream;
    _ = &stream;
    return isatty(fileno(stream)) != 0;
}
pub export fn text_bold(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[1m", stream);
    }
    return stream;
}
pub export fn text_dark(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[2m", stream);
    }
    return stream;
}
pub export fn text_underline(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[4m", stream);
    }
    return stream;
}
pub export fn text_blink(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[5m", stream);
    }
    return stream;
}
pub export fn text_reverse(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[7m", stream);
    }
    return stream;
}
pub export fn text_concealed(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[8m", stream);
    }
    return stream;
}
pub export fn text_gray(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[30m", stream);
    }
    return stream;
}
pub export fn text_grey(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[30m", stream);
...
pub export fn text_red(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[31m", stream);
    }
    return stream;
}
pub export fn text_green(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[32m", stream);
    }
    return stream;
}
pub export fn text_yellow(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[33m", stream);
    }
    return stream;
}
pub export fn text_blue(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[34m", stream);
    }
    return stream;
}
pub export fn text_magenta(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[35m", stream);
    }
    return stream;
}
pub export fn text_cyan(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[36m", stream);
    }
    return stream;
}
pub export fn text_white(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[37m", stream);
    }
    return stream;
}
pub export fn background_gray(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[40m", stream);
    }
    return stream;
}
pub export fn background_grey(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[40m", stream);
...
pub export fn background_red(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[41m", stream);
    }
    return stream;
}
pub export fn background_green(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[42m", stream);
    }
    return stream;
}
pub export fn background_yellow(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[43m", stream);
    }
    return stream;
}
pub export fn background_blue(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[44m", stream);
    }
    return stream;
}
pub export fn background_magenta(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[45m", stream);
    }
    return stream;
}
pub export fn background_cyan(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[46m", stream);
    }
    return stream;
}
pub export fn background_white(arg_stream: [*c]FILE) [*c]FILE {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[47m", stream);
    }
    return stream;
}
pub export fn reset_colors(arg_stream: [*c]FILE) void {
    var stream = arg_stream;
    _ = &stream;
    if (supports_color(stream)) {
        _ = fputs("\x1b[00m", stream);
    }
}
...
pub const DEFUN_T = @compileError("unable to translate macro: undefined identifier `text_`");
// termcolor-c.h:80:9
pub const DEFUN_B = @compileError("unable to translate macro: undefined identifier `background_`");
// termcolor-c.h:107:9
